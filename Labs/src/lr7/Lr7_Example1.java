...
public class Lr7_Example1 {
	public static void main(String[] args) throws InterruptedException {
		File folder = new File("Labs/src/lr7/example1/example_folder");
		if (!folder.exists()) {
			if (folder.mkdirs()) {
		...
		File file = new File(folder.getAbsolutePath() + File.separator + "example1_file.txt");
		try {
			...
			System.out.println("Ошибка при создании фала: " + e.getMessage());
		}
